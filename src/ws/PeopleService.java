 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://ws/", wsdlLocation = "http://vast-sierra-53430.herokuapp.com/ws/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://ws/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://vast-sierra-53430.herokuapp.com/ws/people?wsdl");
    ...
    public People getPeopleImplPort() {
        return super.getPort(new QName("http://ws/", "PeopleImplPort"), People.class);
    }
    ...
    public People getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "PeopleImplPort"), People.class, features);
    }
